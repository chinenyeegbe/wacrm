    ...
    <>
      <div className="h-[70vh] w-full overflow-hidden rounded-lg border border-border bg-background">
        ...
        >
          ...
          <Controls
            className="!border-border !bg-card [&_button]:!border-border [&_button]:!bg-card [&_button:hover]:!bg-secondary"
...
function CanvasAddNodeButton() {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger
        className="inline-flex items-center gap-1.5 rounded-md border border-border bg-card px-3 py-1.5 text-xs font-medium text-foreground shadow-lg transition-colors hover:bg-secondary"
        aria-label="Add node"
      >
