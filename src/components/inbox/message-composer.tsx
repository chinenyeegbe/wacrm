    ...
    <div className="border-t border-border bg-card p-3">
      ...
      <div className="flex items-end gap-2">
        ...
        <textarea
          ...
          rows={1}
          className={cn(
            "flex-1 resize-none rounded-xl border border-border bg-secondary px-4 py-2.5 text-sm text-foreground placeholder-muted-foreground outline-none transition-colors focus:border-primary/50",
